        ...
        modPass.addActionListener((e) -> {
            if (text_pass.getText().equals("")
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(FormularioT2_1.this, "Contraseña modificada con éxito");
                    text_pass.setText("");
        ...
        modLogin.addActionListener((e) -> {
            if (text_pass.getText().equals("")
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(FormularioT2_1.this, "Nombre de usuario cambiado con con éxito");
                    text_pass.setText("");
